...
consists of a single method long power(int, int). This method takes two integers, n and p, as parameters and finds n.pow(p).
If either n or p is negative, then the method must throw an exception which says "n or p should not be negative". Also,
if both  and  are zero, then the method must throw an exception which says "n and p should not be zero."
...
class Solution {
    public static final ExceptionHandling1 my_calculator = new ExceptionHandling1();

...
Hint: You can use comparators to sort a list of objects. https://docs.oracle.com/javase/tutorial/collections/interfaces/order.html

Input Format
The first line of input contains an integer , representing the total number of students. The next  lines contains a
